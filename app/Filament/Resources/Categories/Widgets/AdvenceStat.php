...
class StatsOverview extends BaseWidget
{
    ...
    private function createUserStats(): Stat
    {
        ...
        return Stat::make('Utilisateurs', $totalUsers)
            ...
            ->color($trend['color'])
            // CORRECTION : La méthode tooltip() n'existe plus dans Filament v4
